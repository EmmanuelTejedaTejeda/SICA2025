...
<form method="POST" action="<?= base_url('admin/asignaturas') ?>" enctype="multipart/form-data">
    ...
    <div class="card primary">
        ...
        <div class="card-body">
                ...
                <div class="col-md-3">
                    <div class="form-group mb-3 has-validation">
                        ...
                        <input type="number" min="0" max="50"
                            ...
                            name="horas_practicas" placeholder="3"
                            value="<?php echo set_value('horas_practicas'); ?>" />
                ...
                <div class="col">
                    <div class="form-group mb-3 has-validation">
                        ...
                        <input type="text"
                            ...
                            name="nombre" placeholder="Nombre de la asignatura"
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            name="descripcion"
                            placeholder="Resumen de la asignatura (OPCIONAL)"><?php echo set_value('descripcion'); ?></textarea>
                ...
                <div class="col">
                    <div class="form-group mb-3 has-validation">
                        ...
                        <input type="file" accept="application/pdf"
                            ...
                            name="temario_asignatura" placeholder="Temario de la asignatura"
                            value="<?php echo set_value('temario_asignatura'); ?>" />
            ...
            <div class="row mt-3">
                <div class="form-group mb-3 has-validation">
                    <label for="" class="form-label">Selecciona la carrera</label>
                    <select class="form-select">
                        <?php foreach ($grupocpe as $grupo): ?>
                            <option value="<?=$grupo['grupocpe_id']?>">
                                <?= $grupo['nombre_carrera'] . '-' . $grupo['nombre_periodo'] . '-' . $grupo['nombre_grupo'] ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
