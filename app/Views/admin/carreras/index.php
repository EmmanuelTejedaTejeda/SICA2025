						...
						<div class="row text-center">
							<div class="col">
								<a class="card-link" data-toggle="modal"
									data-target="#editModal<?= $carrera['id']; ?>">Editar</a>
							</div>
							<div class="col">
								<form class="" method="post" action="<?= base_url('admin/carreras/' . $carrera['id']) ?>"
						...
						<div class="modal-body">
							...
							<form action="<?= base_url('admin/carreras/' . $carrera['id']) ?>" method="post">
								...
								<div>
									...
									<input class="form-control" required type="text" name="clave" id="" value="<?php if ($carrera['clave']):
										echo $carrera['clave'];
									else:
										set_value('clave');
									endif; ?>" />
								...
								<div>
									...
									<input class="form-control" required type="text" name="nombre" value="<?php if ($carrera['nombre']):
										echo $carrera['nombre'];
									else:
										set_value('nombre');
									endif; ?>" />
