...
<body>
            ...
            <div class="h-100">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="<?= base_url('asesor/grupos') ?>" class="sidebar-link">
                            <i class="fa-solid fa-person-chalkboard pe-2"></i>
                            Grupos
                        </a>
                        <a href="<?= base_url('asesor/asignaturas') ?>" class="sidebar-link">
                            <i class="fa-solid fa-person-chalkboard pe-2"></i>
                            Asignaturas
                        </a>
                        <a href="<?= base_url('asesor/competencias') ?>" class="sidebar-link">
                            <i class="fa-solid fa-person-chalkboard pe-2"></i>
                            Competencias
                        </a>
    ...
    <script type="text/javascript" class="init">
        $(document).ready(function () {
            if (!$.fn.DataTable.isDataTable('#example')) {  // Verificar si la tabla ya está inicializada
                $('#example').DataTable({
                    language: {
